...
void decodeHuffmanText(TreeNode *root, const char *encodedText, char **huffmanCodes)
{
    cout << "Texto codificado: " << encodedText << endl;
...
int main()
{
    ...
    encodeHuffmanText(huffmanTreeRoot, input_text.c_str(), huffmanCodes);

    cout << "Descifrando el texto:" << endl;
    decodeHuffmanText(huffmanTreeRoot, input_text.c_str(), huffmanCodes);
